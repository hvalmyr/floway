...
func newAuthHandler(svc *service.AdminUserService, tokens *auth.TokenManager, secureCookies bool) *authHandler {
	return &authHandler{svc: svc, tokens: tokens, secureCookies: secureCookies}
}
