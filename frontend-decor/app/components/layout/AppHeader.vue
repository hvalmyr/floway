...
// Placeholder nav — real page set/labels finalized in Phase 4 (п. 6 ТЗ:
// главная, 6 посадочных по типу объекта, портфолио, "как мы работаем",
// контакты). Left/right split kept only for the existing header layout.
const leftLinks = [
