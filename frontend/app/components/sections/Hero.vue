 ...
 * mockup, and sit flush with the media's bottom edge (the text column
 * stretches to the media's height via `items-stretch` + `mt-auto` on the
 * actions wrapper). `.container` caps overall width so this doesn't stretch
