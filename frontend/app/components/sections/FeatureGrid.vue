...
<template>
  <div class="grid grid-cols-1 items-start gap-24 md:grid-cols-2 lg:grid-cols-3 lg:gap-32">
    <div
      v-for="(item, i) in items"
      :key="i"
      class="flex flex-col items-center gap-16 rounded-md bg-white p-32 text-center"
    >
