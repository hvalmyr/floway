...
const emptyForm = (): Omit<CarouselPhoto, "id"> => ({ image: "", sortOrder: 0 });

const { items, loading, error, fetchAll, create, update, remove } = useAdminResource<CarouselPhoto>(
  props.apiPath,
);
...
function startEdit(photo: CarouselPhoto) {
